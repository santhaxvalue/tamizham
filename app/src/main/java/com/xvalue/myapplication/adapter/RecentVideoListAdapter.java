...
public class RecentVideoListAdapter extends RecyclerView.Adapter<RecentVideoListAdapter.ViewHolder> {
    ...
    public RecentVideoListAdapter(Context context, List<HomePageResponse.Data.FavouriteVideo> homepagesingleresponsefavourite) {
        ...
        this.homepagesingleresponsefavourite = homepagesingleresponsefavourite;
    }
...
//        holder.pJobProfile.setText(pu.getVideoUrlLow());
    ...
    public int getItemCount() {
        return homepagesingleresponsefavourite.size();
    }
